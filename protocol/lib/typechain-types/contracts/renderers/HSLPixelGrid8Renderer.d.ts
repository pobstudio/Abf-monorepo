...
export interface HSLPixelGrid8RendererInterface extends utils.Interface {
    functions: {
...
export interface HSLPixelGrid8Renderer extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: HSLPixelGrid8RendererInterface;
...
//# sourceMappingURL=HSLPixelGrid8Renderer.d.ts.map