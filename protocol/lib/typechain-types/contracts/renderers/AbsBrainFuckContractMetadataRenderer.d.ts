...
export interface AbsBrainFuckContractMetadataRendererInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "DEFAULT_CONTRACT_DESCRIPTION" | "DEFAULT_CONTRACT_IMAGE" | "additionalMetadataURI" | "name" | "owner" | "propsSize" | "render" | "renderRaw" | "renderType" | "renounceOwnership" | "supportsInterface" | "transferOwnership"): FunctionFragment;
...
export interface AbsBrainFuckContractMetadataRenderer extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: AbsBrainFuckContractMetadataRendererInterface;
...
//# sourceMappingURL=AbsBrainFuckContractMetadataRenderer.d.ts.map