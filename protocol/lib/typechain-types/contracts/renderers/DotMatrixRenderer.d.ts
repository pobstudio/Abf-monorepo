...
export interface DotMatrixRendererInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "RADIUS_MAX" | "RADIUS_MIN" | "additionalMetadataURI" | "attributes" | "name" | "owner" | "propsSize" | "render" | "renderAttributeKey" | "renderRaw" | "renounceOwnership" | "supportsInterface" | "transferOwnership"): FunctionFragment;
    encodeFunctionData(functionFragment: "RADIUS_MAX", values?: undefined): string;
    encodeFunctionData(functionFragment: "RADIUS_MIN", values?: undefined): string;
...
//# sourceMappingURL=DotMatrixRenderer.d.ts.map