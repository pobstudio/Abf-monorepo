...
export interface DotMatrixRendererInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "RADIUS_MAX" | "RADIUS_MIN" | "additionalMetadataURI" | "name" | "owner" | "propsSize" | "render" | "renderRaw" | "renderType" | "renounceOwnership" | "supportsInterface" | "transferOwnership"): FunctionFragment;
