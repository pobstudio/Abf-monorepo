...
export interface BrainfuckMiddlewareRendererInterface extends utils.Interface {
    functions: {
        ...
        "tokenSeed(bytes32,uint256,bytes32)": FunctionFragment;
        "transferOwnership(address)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "additionalMetadataURI" | "name" | "owner" | "propsSize" | "render" | "renderRaw" | "renderType" | "renounceOwnership" | "supportsInterface" | "tokenSeed" | "transferOwnership"): FunctionFragment;
...
export interface BrainfuckMiddlewareRenderer extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: BrainfuckMiddlewareRendererInterface;
...
//# sourceMappingURL=BrainfuckMiddlewareRenderer.d.ts.map