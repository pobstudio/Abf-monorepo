...
export interface GifImageRendererInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "GRAPHIC_CONTROL_EXTENSION" | "HEIGHT_INDEX" | "IMAGE_DATA_CHUNK_SIZE" | "IMAGE_DESCRIPTOR" | "NUM_COLORS_INDEX" | "WIDTH_INDEX" | "additionalMetadataURI" | "attributes" | "name" | "owner" | "propsSize" | "render" | "renderAttributeKey" | "renderRaw" | "renounceOwnership" | "supportsInterface" | "transferOwnership"): FunctionFragment;
