...
export interface LayerCompositeRendererInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "additionalMetadataURI" | "encodeProps" | "name" | "owner" | "propsSize" | "render" | "renderRaw" | "renderType" | "renounceOwnership" | "supportsInterface" | "transferOwnership"): FunctionFragment;
