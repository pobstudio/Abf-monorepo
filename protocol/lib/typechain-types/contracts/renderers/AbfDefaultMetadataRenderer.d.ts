...
export interface AbfDefaultMetadataRendererInterface extends utils.Interface {
    functions: {
...
export interface AbfDefaultMetadataRenderer extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: AbfDefaultMetadataRendererInterface;
...
//# sourceMappingURL=AbfDefaultMetadataRenderer.d.ts.map