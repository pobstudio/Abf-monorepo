...
export interface ERC721ZDefaultMetadataRendererInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "additionalMetadataURI" | "name" | "owner" | "propsSize" | "render" | "renderRaw" | "renderType" | "renounceOwnership" | "supportsInterface" | "transferOwnership"): FunctionFragment;
...
export interface ERC721ZDefaultMetadataRenderer extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ERC721ZDefaultMetadataRendererInterface;
...
//# sourceMappingURL=ERC721ZDefaultMetadataRenderer.d.ts.map