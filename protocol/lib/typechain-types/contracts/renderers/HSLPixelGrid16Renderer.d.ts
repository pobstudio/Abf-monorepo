...
export interface HSLPixelGrid16RendererInterface extends utils.Interface {
    functions: {
...
export interface HSLPixelGrid16Renderer extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: HSLPixelGrid16RendererInterface;
...
//# sourceMappingURL=HSLPixelGrid16Renderer.d.ts.map