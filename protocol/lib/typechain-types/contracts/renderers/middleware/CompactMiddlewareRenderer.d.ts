...
export interface CompactMiddlewareRendererInterface extends utils.Interface {
    functions: {
...
export interface CompactMiddlewareRenderer extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: CompactMiddlewareRendererInterface;
...
//# sourceMappingURL=CompactMiddlewareRenderer.d.ts.map