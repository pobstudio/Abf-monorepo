...
export interface HSLPixelGrid24RendererInterface extends utils.Interface {
    functions: {
...
export interface HSLPixelGrid24Renderer extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: HSLPixelGrid24RendererInterface;
...
//# sourceMappingURL=HSLPixelGrid24Renderer.d.ts.map