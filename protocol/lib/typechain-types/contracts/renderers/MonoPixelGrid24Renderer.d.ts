...
export interface MonoPixelGrid24RendererInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "additionalMetadataURI" | "attributes" | "name" | "owner" | "propsSize" | "render" | "renderAttributeKey" | "renderRaw" | "renounceOwnership" | "supportsInterface" | "transferOwnership"): FunctionFragment;
...
export interface MonoPixelGrid24Renderer extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: MonoPixelGrid24RendererInterface;
...
//# sourceMappingURL=MonoPixelGrid24Renderer.d.ts.map