...
export interface ChunkedDataStorageInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "MAX_UINT_16" | "batchAddChunkedData" | "currentMaxChunksIndex" | "indexToData" | "numLayerDataInChunk" | "owner" | "renounceOwnership" | "supportsInterface" | "transferOwnership"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "numLayerDataInChunk", values: [PromiseOrValue<BigNumberish>]): string;
    ...
    decodeFunctionResult(functionFragment: "numLayerDataInChunk", data: BytesLike): Result;
...
export interface ChunkedDataStorage extends BaseContract {
    ...
    functions: {
        ...
        numLayerDataInChunk(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    populateTransaction: {
        ...
        numLayerDataInChunk(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
...
//# sourceMappingURL=ChunkedDataStorage.d.ts.map