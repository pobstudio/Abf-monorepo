...
export interface IRendererInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "additionalMetadataURI" | "attributes" | "name" | "owner" | "propsSize" | "render" | "renderAttributeKey" | "renderRaw" | "supportsInterface"): FunctionFragment;
