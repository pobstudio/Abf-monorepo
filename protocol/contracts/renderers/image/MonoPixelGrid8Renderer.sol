...
contract MonoPixelGrid8Renderer is IRenderer, Ownable, ERC165 {
  ...
  {
    return 'ipfs://bafkreig6udy2547len2y3rxlrrvw6fkniqdawmbox6de6a6k77sdbq7l4q';
  }
    ...
    for (uint256 i = 0; i < 64; ++i) {
      content = string(
        abi.encodePacked(
          ...
          rects[i],
          ' fill="',
          SvgUtils.toColorHexStringByBytes(props[i], props[i], props[i]),
          rectSuffix
        )
      );
    }
