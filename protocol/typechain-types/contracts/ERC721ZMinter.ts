...
export interface ERC721ZMinterInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      | 'MAX_MINTING_PER_ADDRESS'
      | 'MAX_MINTING_PER_WHITELIST_TOKEN'
      | 'claim'
      | 'claimMerkleRoot'
      | 'claimMerkleTreeURI'
      | 'init'
  ...
  encodeFunctionData(
    functionFragment: 'MAX_MINTING_PER_ADDRESS',
    values?: undefined,
  ): string;
  encodeFunctionData(
    functionFragment: 'MAX_MINTING_PER_WHITELIST_TOKEN',
    values?: undefined,
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: 'claimMerkleRoot',
    values?: undefined,
  ): string;
  encodeFunctionData(
    functionFragment: 'claimMerkleTreeURI',
    values?: undefined,
  ): string;
  encodeFunctionData(
...
export interface ERC721ZMinter extends BaseContract {
  ...
  functions: {
    ...
    init(
      ...
      config: ERC721ZMinter.InitConfigStruct,
      overrides?: Overrides & { from?: PromiseOrValue<string> },
    ): Promise<ContractTransaction>;
    ...
    setRoyaltyTreasury(
      _royaltyTreasury: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> },
    ): Promise<ContractTransaction>;
