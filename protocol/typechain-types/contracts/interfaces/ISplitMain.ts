...
export interface ISplitMain extends BaseContract {
  ...
  functions: {
    ...
    withdraw(
      ...
      withdrawETH: PromiseOrValue<BigNumberish>,
  ...
  filters: {
    'CancelControlTransfer(address)'(
      split?: PromiseOrValue<string> | null,
    ...
    'DistributeERC20(address,address,uint256,address)'(
      ...
      amount?: null,
      distributorAddress?: PromiseOrValue<string> | null,
    ...
    'InitiateControlTransfer(address,address)'(
      split?: PromiseOrValue<string> | null,
      newPotentialController?: PromiseOrValue<string> | null,
