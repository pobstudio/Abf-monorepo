...
export interface AbsBrainFuckURIConstructorInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic: 'contractURI' | 'decodeProps' | 'tokenURI',
  ): FunctionFragment;
...
export interface AbsBrainFuckURIConstructor extends BaseContract {
  ...
  functions: {
    ...
    tokenURI(
      ...
      propsPrefix: PromiseOrValue<BytesLike>,
      propsSuffix: PromiseOrValue<BytesLike>,
