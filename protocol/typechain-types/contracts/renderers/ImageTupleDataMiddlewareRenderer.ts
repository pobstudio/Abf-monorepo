...
export interface ImageTupleDataMiddlewareRendererInterface
...
export interface ImageTupleDataMiddlewareRenderer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ImageTupleDataMiddlewareRendererInterface;
