...
export interface AbsBrainFuckConstantsInterface extends utils.Interface {
  ...
  getFunction(
    nameOrSignatureOrTopic:
      | 'ANIMATION_RENDER_TYPE'
      | 'ATTRIBUTES_RENDER_TYPE'
  ...
  encodeFunctionData(
    functionFragment: 'ANIMATION_RENDER_TYPE',
    values?: undefined,
  ): string;
  encodeFunctionData(
    functionFragment: 'ATTRIBUTES_RENDER_TYPE',
    values?: undefined,
  ): string;
  encodeFunctionData(
    functionFragment: 'DEFAULT_CONTRACT_DESCRIPTION',
    values?: undefined,
  ): string;
  encodeFunctionData(
    functionFragment: 'DEFAULT_CONTRACT_IMAGE',
    values?: undefined,
  ): string;
  encodeFunctionData(
    functionFragment: 'IMAGE_RENDER_TYPE',
    values?: undefined,
  ): string;
  encodeFunctionData(
