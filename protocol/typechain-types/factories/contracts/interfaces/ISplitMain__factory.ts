...
import type {
  ISplitMain,
  ISplitMainInterface,
} from '../../../contracts/interfaces/ISplitMain';
...
export class ISplitMain__factory {
  static readonly abi = _abi;
  static createInterface(): ISplitMainInterface {
    return new utils.Interface(_abi) as ISplitMainInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider,
  ): ISplitMain {
    return new Contract(address, _abi, signerOrProvider) as ISplitMain;
  }
}
