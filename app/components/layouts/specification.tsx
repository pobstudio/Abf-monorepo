...
interface IRenderer is IERC165 {
  ...
  function outSize() returns (uint256);
  ...
  function attributes(bytes calldata out) returns (string);
      ...
      `}
            ...
            <P>
              <Code>outSize</Code>: the expected size of the provided bytes for
              the renderer to function. Can be set to <Code>MAX_UINT</Code> if
              renderer can work with any amount of bytes.
            </P>
            <P>
